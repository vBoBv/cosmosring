# Generated by Django 3.1 on 2020-09-22 12:05
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('discount', models.ManyToManyField(blank=True, to='ecommerce_app.Discount')),
            ],
        ),
        migrations.CreateModel(
            name='Customer',
        ...
        migrations.AddField(
            model_name='order',
            name='order_manager',
            field=models.ManyToManyField(to='ecommerce_app.OrderManager'),
        ),
    ]
